package com.test.relationship.services;
...
@Service // esta clase sera un bean
public class StudentService {
    ...
    public void updateStudent(Long studentId, String name, String email) {
        Student student =
                studentRepository.findById(studentId).orElseThrow(()-> new IllegalStateException("student with id "+studentId+" does not exist"));
